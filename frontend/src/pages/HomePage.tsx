  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Link to="/" className="flex flex-col items-start">
                ...
                />
                <span className="text-xs text-gray-600">Brand Intelligence</span>
              </Link>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link to="/signup" className="bg-gradient-to-r from-cyan-500 to-yellow-500 text-white px-4 py-2 rounded-lg font-medium hover:shadow-lg transition transform hover:scale-105">
                Get Started Free
              </Link>
            </div>
          </div>
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-50 via-yellow-50 to-yellow-100 opacity-70"></div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center px-3 py-1 rounded-full bg-cyan-100 text-cyan-700 text-sm font-medium mb-6">
              ...
              <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-yellow-500"> 5 minutes</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Link to="/signup" className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-cyan-500 to-yellow-500 text-white font-medium rounded-lg hover:shadow-xl transition transform hover:scale-105">
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-400 to-yellow-500 rounded-3xl transform rotate-3 scale-105 opacity-20"></div>
              <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
                <img 
                  src="https://images.unsplash.com/photo-1573164713714-d95e436ab8d6?w=800&h=600&fit=crop" 
                  alt="African entrepreneurs working on brand strategy"
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm font-bold text-cyan-600">85%</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div className="bg-gradient-to-r from-cyan-500 to-yellow-500 h-2 rounded-full" style={{ width: '85%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="group hover:shadow-xl transition-all duration-300 bg-gray-50 rounded-2xl p-6 hover:bg-white">
                <div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-yellow-500 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="relative">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-cyan-500 to-yellow-500 rounded-full flex items-center justify-center text-white font-bold text-xl">1</div>
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-cyan-500 to-yellow-500 rounded-full flex items-center justify-center text-white font-bold text-xl">2</div>
            ...
            <div className="relative">
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-cyan-500 to-yellow-500 rounded-full flex items-center justify-center text-white font-bold text-xl">3</div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="grid grid-cols-2 gap-2">
                    <div className="h-16 bg-gradient-to-br from-cyan-200 to-yellow-200 rounded"></div>
                    <div className="h-16 bg-gradient-to-br from-yellow-200 to-yellow-300 rounded"></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricingTiers.map((tier, index) => (
              <div key={index} className={`relative rounded-2xl ${tier.highlighted ? 'shadow-2xl scale-105' : 'shadow-lg'} bg-white overflow-hidden hover:shadow-xl transition`}>
                {tier.highlighted && (
                  <div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-cyan-500 to-yellow-500 text-white text-center py-1 text-sm font-medium">
                    Most Popular
                  </div>
                )}
                <div className={`p-8 ${tier.highlighted ? 'pt-12' : ''}`}>
                  ...
                  <Link 
                    ...
                    className={`block text-center py-3 px-6 rounded-lg font-medium transition ${
                      tier.highlighted 
                        ? 'bg-gradient-to-r from-cyan-500 to-yellow-500 text-white hover:shadow-lg' 
            ...
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition">
                ...
                <div className="flex items-center">
                  ...
                  />
                  <div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-yellow-500 rounded-full mr-4 hidden items-center justify-center">
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-cyan-500 to-yellow-500">
                ...
                <img 
                  ...
                  onError={(e) => {
                    ...
                    if (target.src.includes('light')) {
                      target.src = '/logo_dark.png';
                    }
                  }}
                />
                <span className="text-sm text-gray-300">Brand Intelligence</span>
              </div>
